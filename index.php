...
function index()
{
    ...
    if ($GLOBALS['xoopsUser'] instanceof \XoopsUser) {
        $add_listing = '' . _ADSLIGHT_ADD_LISTING_BULLOK . '<a rel="nofollow" class="btn btn-success text-right"  title="Подать объявление" href="add.php">' . _ADSLIGHT_ADD_LISTING_SUBOK . '</a>';
    } else {
